...
def register_trade(
    ...
    **kwargs,
    ...
    direct_args = {
        ...
        "range_detected": kwargs.get("range_detected"),
        "range_high": kwargs.get("range_high"),
        "range_low": kwargs.get("range_low"),
        "range_width_pct": kwargs.get("range_width_pct"),
        "range_position_pct": kwargs.get("range_position_pct"),
        "range_zone": kwargs.get("range_zone"),
        "range_note": kwargs.get("range_note"),
        "confirmed_range_breakout": kwargs.get("confirmed_range_breakout"),
    ...
    docs = build_trade_diagnostics({
        ...
        "range_detected": _get_val("range_detected", False),
        "range_high": _get_val("range_high"),
        "range_low": _get_val("range_low"),
        "range_width_pct": _get_val("range_width_pct"),
        "range_position_pct": _get_val("range_position_pct"),
        "range_zone": _get_val("range_zone", ""),
        "range_note": _get_val("range_note", ""),
        "confirmed_range_breakout": _get_val("confirmed_range_breakout", False),
