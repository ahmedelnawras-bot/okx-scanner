...
RECIPES: dict[str, tuple[GateRecipe, ...]] = {
    "normal": (
        ...
        GateRecipe(
            ...
            description="يختبر Normal كاستمرار نظيف قائم على structure/reclaim فقط، بدون relative strength وحدها.",
        ...
        GateRecipe(
            name="normal_runner_selective",
            mode_key="normal",
            title="Normal باحتمال امتداد للـ Runner",
            description="يختبر فرص Normal التي قد تصل TP2/runner عبر reclaim أو wave_3 بفوليوم أعلى.",
            min_quality_score=70,
            allowed_setups=tuple(sorted({"vwap_reclaim", "higher_low_continuation", "wave_3", "retest_breakout_confirmed"})),
        ...
        GateRecipe(
            name="normal_watchdog_safe",
            mode_key="normal",
            title="Watchdog شديد الانتقاء",
            description="أضيق خلطة Normal: عدد قليل جدًا، رفض قوي للمخاطر، وقبول لأوضح setups فقط.",
            min_quality_score=78,
            allowed_setups=tuple(sorted({"higher_low_continuation", "vwap_reclaim"})),
            clean_setups_only=True,
            allow_relative_strength=False,
            min_vol_ratio=1.20,
            reject_high_risk_without_edge=True,
    ...
    "strong": (
        ...
        GateRecipe(
            ...
            description="خلطة منافسة تختبر breakout/reclaim النظيف مع حماية near resistance، بدون تعديل strong_strict.",
        ...
        GateRecipe(
            ...
            description="يركز على setups التي يُفترض أن تعطي امتدادًا أكبر للـ runner: wave_3 و vwap_reclaim و relative strength بفوليوم واضح.",
            min_quality_score=72,
        ...
        GateRecipe(
            name="strong_low_noise",
            mode_key="strong",
            title="ضوضاء أقل وجودة أعلى",
            description="خلطة أضيق لتقليل عدد الصفقات: جودة أعلى، فوليوم أعلى، ورفض أقوى للرموز الخطرة والامتداد غير المؤكد.",
            min_quality_score=76,
            allowed_setups=tuple(sorted({"vwap_reclaim", "wave_3", "retest_breakout_confirmed"})),
