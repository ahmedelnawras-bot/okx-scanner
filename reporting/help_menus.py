...
def build_diagnostics_help() -> str:
    return "\n".join([
        ...
        "/gate_sim_normal",
        "↳ يحاكي بوابة NORMAL على replay + live بدون تطبيقها.",
        "/gate_sim_recovery",
        "↳ يحاكي بوابة RECOVERY على replay + live بدون تطبيقها.",
        "/gate_sim_strong",
        "↳ يحاكي بوابة STRONG على replay + live بدون تطبيقها.",
        "/gate_sim_all",
        "↳ ملخص سريع لمحاكاة كل البوابات.",
        "",
        "━━━━━━━━━━━━",
