...
def build_diagnostics_help() -> str:
    return "\n".join([
        ...
        "/tech_snapshot_clear — مسح داتا snapshots فقط",
        "/gate_suggestions — قراءة مبدئية للبوابات",
        "",
        "━━━━━━━━━━━━",
        "🕰 Historical Replay Engine",
        "/help_historical_replay — أوامر محرك التاريخ",
        "/replay_start_30d — تشغيل Replay آخر 30 يوم",
        "/replay_start_45d — تشغيل Replay آخر 45 يوم عند الحاجة",
        "/replay_status — حالة المحرك",
        "/replay_stop — إيقاف آمن",
        "/replay_export — معاينة Replay الخام",
        "/replay_export_file — إرسال ملف Replay ZIP",
        "/replay_summary — ملخص Replay",
        "/replay_clear — مسح داتا Replay فقط",
        "/compare_live_vs_replay — مقارنة Live مع Replay",
        "",
