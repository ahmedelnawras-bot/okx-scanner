...
def build_report_bundle(trades, execution_results, signal_items, execution_starting_balance: float = 1000.0, execution_margin_per_trade: float = 35.0):
    ...
    return {
        ...
        "execution": build_execution_report(
            ...
            starting_balance=execution_starting_balance,
            margin_per_trade=execution_margin_per_trade,
        ),
        "execution_wallet": build_wallet_report(
            execution_trades,
            starting_balance=execution_starting_balance,
            margin_per_trade=execution_margin_per_trade,
...
def build_command_outputs(trades, execution_results, signal_items, execution_starting_balance: float = 1000.0, execution_margin_per_trade: float = 35.0):
    execution_trades = _execution_trades(trades)
    normal_trades = _normal_trades(trades)
    bundle = build_report_bundle(trades, execution_results, signal_items, execution_starting_balance, execution_margin_per_trade)
    commands = {
